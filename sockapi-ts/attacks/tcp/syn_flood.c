...
/* 
 * Test attacks/tcp/syn_flood  
 * TCP SYN flood
 */

/** @page attacks-tcp-syn_flood TCP SYN flood
 *
 * @objective Check that TCP SYN flood does not lead to denial of service.
 *
 ...
 *    TCP SYN packets from different source IP addresses/ports and to
...
#define TE_TEST_NAME  "attacks/tcp/syn_flood"
