...
/** @page sockopts-error_errqueue_tcp TCP socket state is not affected by ICMP error messages
 *
...
#define TE_TEST_NAME  "sockopts/error_errqueue_tcp"
...
main(int argc, char *argv[])
{
   ...
   TAPI_WAIT_NETWORK;
    ...
    if ((rpc_errno)opt_val != RPC_EOK)
        TEST_FAIL("Received sequence of ICMP messages should be discarded on"
                  " TCP socket, but SO_ERROR option is set "
