...
/** @page ioctls-fionbio_thread_unblock_connect FIONBIO from thread when connect() operation is blocked
 *
 * @objective Try @c FIONBIO from thread
 * when connect() operation is blocked in another thread.
 *
